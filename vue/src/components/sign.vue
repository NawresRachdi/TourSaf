<template>
  ...
  <div class="bg-black/80 font-[sans-serif] relative z-50">
    <div class="min-h-screen flex flex-col items-center justify-center py-6 px-4">
      <div class="max-w-md w-full">
        
        <div class="p-8 rounded-2xl bg-white shadow relative">
            <div class="rouded-full text-red-500 text-xl cursor-pointer ml-[98%]" @click="emit('close')">X</div>
